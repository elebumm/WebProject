...
*/
document.write("<style>.a_dhx_hidden_input{ position:absolute;  top:-1px; left:-1px; width:1px; height:1px; border:none; background:none; }</style>");
...
/**
*     @desc: enable search items by key pressing
*     @param: mode - true/false
*     @edition: Professional
*     @type: public
*     @topic: 4
